...
const ClimbProfileChart: React.FC<ClimbProfileProps> = ({ climbProfile, zoomLevel = 1, svgRef, chartWidth = 800, showActualElevation = false }) => {
    ...
    useEffect(() => {
        ...
        // Set up dimensions and smargins
        ...
        drawChartintervals(svg, data, xScale, yScale, height, margin);
...
// Helper method to draw the chart intervals
const drawChartintervals = (
    svg: d3.Selection<SVGSVGElement | null, unknown, null, undefined>,
    data: Section[],
