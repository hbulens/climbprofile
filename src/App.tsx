    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <div className="flex justify-center mb-4">
          <button onClick={() => setZoomLevel(zoomLevel > 0 ? -1 : zoomLevel - 1)} className="p-2 bg-green-500 text-white rounded mx-2">
            -
          </button>
          <button
            onClick={() => setZoomLevel(zoomLevel < 0 ? 1 : zoomLevel + 1)} className="p-2 bg-red-500 text-white rounded mx-2">
            +
          </button>
        </div>
